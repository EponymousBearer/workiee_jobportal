        ...
        <div class="mx-auto max-w-8xl px-6 py-10 sm:px-6 lg:px-10 lg:py-12">
            ...
            <div class="flex items-stretch justify-center mt-2 md:mt-4">
                <div class="grid md:grid-cols-2">
                    ...
                    <div class="border-2 border-gray-200 flex justify-center items-center hidden md:block">
                        <!-- Google Map Section -->
                        <div class="flex h-full w-full">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3619.3528734104984!2d67.11623757414193!3d24.885942344239666!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3eb339ff8caf7a51%3A0x5eaa629f8ff19073!2sNational%20Aerospace%20Science%20and%20Technology%20Park%20(NASTP)!5e0!3m2!1sen!2s!4v1712250125165!5m2!1sen!2s" width="650" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                        <!-- <div id="map"></div>
                        prettier-ignore
